...
{
    public partial class JudgeVotingForm : Form, IScoringDetails, IVoting, ICandidate, IVoteHistory
    {
        private readonly CompetitionSelector competition;
        public JudgeVotingForm(Scoring Competition, CompetitionSelector competition)
        {
            InitializeComponent();
        ...
        public void UpdateVoteLogs()
        {
            ScoreLogs = new Scoring
            {
                ...
                CriteriaPointsID =
                {
                    ...
                    int.Parse(scoreFifthCriteria.Tag.ToString()),
                },
                Criterias =
                {
                    ...
                    new Criteria { CriteriaID = int.Parse(scoreFifthCriteria.Tag.ToString()) },
                },
                CriteriaScores =
                {
                    ...
                    decimal.Parse( scoreFifthCriteria.Text),

                },
                TotalPoints = (float)float.Parse(scoreFirstCriteria.Text) + float.Parse(scoreSecondCriteria.Text)
                            + float.Parse(scoreThirdCriteria.Text) + float.Parse(scoreFourthCriteria.Text) + float.Parse(scoreFifthCriteria.Text)
            };
        ...
        private void SetVoteLogs()
        {
            try
            {
                ...
                scoreFifthCriteria.Text = scoreLogs.CriteriaScores[4].ToString();
                ...
                scoreFifthCriteria.Tag = scoreLogs.CriteriaPointsID[4];
        ...
        public void SetScoring()
        {
            ...
            if (CriteriaScoring.Count == 5)
            {
                lblFifthCriteria.Visible = true;
                lblPercentageFifthCriteria.Visible = true;
                scoreFifthCriteria.Visible = true;

                lblFifthCriteria.Text = CriteriaScoring[4].Title;
                lblFifthCriteria.Tag = CriteriaScoring[4].CriteriaID.ToString();
                lblPercentageFifthCriteria.Text = $"{CriteriaScoring[4].Percentage.ToString()}%";
        ...
        private void ResetScoring()
        {
            ...
            scoreFifthCriteria.Text = 0.ToString();
        }
        ...
        private void btnVote_Click(object sender, EventArgs e)
        {
            if (decimal.Parse(scoreFirstCriteria.Text) <= 1
                ...
                || decimal.Parse(scoreFifthCriteria.Text) <= 1)
            {
        ...
        private void scoreFifthCriteria_TextChanged(object sender, EventArgs e)
        {
            decimal value;
            if (decimal.TryParse(scoreFifthCriteria.Text, out value))
            {
                if (value > CriteriaScoring[4].Percentage)
                {
                    scoreFifthCriteria.Text = CriteriaScoring[4].Percentage.ToString();
                }
            }
